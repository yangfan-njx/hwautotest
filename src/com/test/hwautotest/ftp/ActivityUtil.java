...
public class ActivityUtil extends Activity{
	...
	public   static void goActivityWithDoData(Context context,Class<?> tarActivityClass,int data_ftpType,String data_filePath){//<?>通配所有类型
		Intent intent=new Intent();
	 ...
	 * @param data_filePath
	 */
	public   static void goActivityWithString(Context context,Class<?> tarActivityClass,String keyName,String data_filePath){//<?>通配所有类型
		Intent intent=new Intent();
	 ...
	 * @param data_filePath
	 */
	public   static void goActivityWithString2(Context context,Class<?> tarActivityClass,String keyName,String data_filePath,String key2,String data_fileSize ){//<?>通配所有类型
		Intent intent=new Intent();
		intent.putExtra(keyName, data_filePath);
